    ...
    <div className='policy-main-container padding-global'>
      ...
      <div className='policy-container'>
        ...
        <p className='mt-10'>
          ...
          I request will be collected by me. The payment info you are using to use prime feature will be send to third party and I will not store any payment info other that paymentId and orderId.
        </p>
        ...
        <p className='mt-10'>
          ...
          Privacy Policy, do not hesitate to contact me at support@habstreak.com.
        </p>
